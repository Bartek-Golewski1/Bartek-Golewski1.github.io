...
class SongController
{
    ...
    {
        if ($requestPost) {
            $song = Song::fromArray($requestPost);
            // @todo validation
            $song->save();
    ...
    public function editAction(int $songId, ?array $requestPost, Templating $templating, Router $router): ?string
    {
